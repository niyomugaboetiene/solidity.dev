...
export interface MyNFTMetadataInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface MyNFTMetadata extends BaseContract {
  connect(runner?: ContractRunner | null): MyNFTMetadata;
  waitForDeployment(): Promise<this>;

  interface: MyNFTMetadataInterface;
